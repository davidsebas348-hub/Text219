...
local function duplicateTool(num)
    ...
    local original = backpack:FindFirstChild(ghostName)
...
screenGui.Name = "GhostDuplicatorGUI"
...
textBox.PlaceholderText = "Cantidad de Ghost"
textBox.Text = "1"
...
activateButton.MouseButton1Click:Connect(function()
    ...
    if num > 0 then duplicateTool(num) end
end)
